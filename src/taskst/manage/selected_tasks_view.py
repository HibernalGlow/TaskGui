...
from taskst.utils.selection_utils import clear_all_selections, get_global_state, init_global_state
    ...
    with col3:
        if st.button("运行选中的任务", key="run_selected_tasks"):
            if not selected_tasks:
                ...
                from taskst.services.task_runner import run_multiple_tasks
