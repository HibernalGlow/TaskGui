...
# 导入自定义模块
from taskst.utils.session_utils import init_session_state, setup_css
from taskst.services.taskfile import load_taskfile, read_taskfile
from taskst.services.dataframe import prepare_dataframe, filter_tasks
from taskst.components.tag_filters import get_all_tags, render_tag_filters
from taskst.views.table.table_view import render_table_view
from taskst.views.card.card_view import render_card_view
from taskst.components.sidebar import render_sidebar, get_base64_encoded_image, set_background_image, set_sidebar_background
from taskst.utils.file_utils import open_file, get_directory_files, find_taskfiles, get_nearest_taskfile, copy_to_clipboard, get_task_command
from taskst.services.task_runner import run_task_via_cmd, run_multiple_tasks
from taskst.components.preview_card import render_action_buttons
from taskst.manage.state_manager import render_state_manager
from taskst.tabs.dashboard import render_dashboard
from taskst.utils.selection_utils import (
...
# 导入新的模块化组件
from taskst.ui.config import setup_page_config
from taskst.ui.styles import apply_custom_css, add_clipboard_js
from taskst.tabs.settings import render_settings_tab, load_basic_settings
from taskst.tabs.preview_tab import render_preview_tab
...
def main():
    ...
    try:
        ...
        # 初始化AgGrid设置
        from taskst.views.table.aggrid_config import init_aggrid_settings
        ...
        # 获取任务文件管理器
        from taskst.config.taskfile_manager import get_taskfile_manager
