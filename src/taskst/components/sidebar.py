...
from taskst.services.taskfile import read_taskfile, load_taskfile
from taskst.utils.selection_utils import save_favorite_tags, save_background_settings, load_background_settings, get_selected_tasks, get_card_view_settings, load_local_config, update_global_state, get_global_state, get_task_selection_state, update_task_selection, record_task_run
import os
import sys
import subprocess
import base64
...
import pandas as pd
from taskst.utils.file_utils import get_directory_files, get_task_command
from taskst.services.task_runner import run_task_via_cmd
from taskst.views.card.card_view import group_tasks_by_first_tag, sort_grouped_tasks
from taskst.utils.file_utils import copy_to_clipboard
import hashlib
# 导入已被移到设置页面的任务文件管理组件 (仅用于注释，不使用)
# from taskst.components.taskfile_manager_ui import render_taskfile_manager_expander
...
def render_appearance_expander(current_taskfile):
    """渲染外观设置expander"""
    # 导入背景设置相关函数
    from taskst.utils.selection_utils import load_background_settings, save_background_settings
